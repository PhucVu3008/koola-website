          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="flex w-full items-center justify-between px-4 sm:px-6 py-3 sm:py-4 text-left transition-colors hover:bg-slate-50"
              ...
              {/* Accordion Content */}
              {isExpanded && (
                <div className="border-t border-slate-100 px-4 sm:px-6 py-4 sm:py-5 space-y-5 animate-in fade-in slide-in-from-top-2 duration-300">
                  {/* Location & Level */}
